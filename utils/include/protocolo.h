...
typedef enum
{
    ...
    QUERY_RESPONSE_ERROR_ARCHIVO_NO_ENCONTRADO, //  WORKER_ERROR_DIRECCION_INVALIDA archivo que no fue creado antes
    QUERY_RESPONSE_ERROR_ARCHIVO_QUERY_NO_ENCONTRADO, //  WORKER_ERROR_QUERY_NO_ENCONTRADA path
    QUERY_RESPONSE_ERROR_WORKER_DESCONECTADO,
    QUERY_RESPONSE_ERROR_ERROR_EN_INSTRUCCION, //  WORKER_ERROR_INSTRUCCION_MALFORMADA
    QUERY_RESPONSE_ERROR_MODIFICAR_COMMIT, // WORKER_ERROR_MODIFICAR_COMMIT,
    QUERY_RESPONSE_ERROR_TAMANIO_ESCRITURA_EXCEDIDO, // WORKER_ERROR_TAMANIO_ESCRITURA_EXCEDIDO,
    QUERY_RESPONSE_ERROR_TAMANIO_LECTURA_EXCEDIDO, // WORKER_ERROR_TAMANIO_LECTURA_EXCEDIDO, 
    QUERY_ERROR_CREATE,
    QUERY_ERROR_TRUNCATE,
    QUERY_ERROR_WRITE_EN_STORAGE,
    QUERY_ERROR_READ_EN_STORAGE,
    QUERY_ERROR_TAG,
    QUERY_ERROR_COMMIT,
    QUERY_ERROR_DELETE,
    QUERY_ERROR_FLUSH,
    ...
    WORKER_ERROR_INSTRUCCION_MALFORMADA,     // si
    WORKER_ERROR_MODIFICAR_COMMIT, // si
